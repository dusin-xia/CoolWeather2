package edu.just.dusin.coolweather2.util;
...
import edu.just.dusin.coolweather2.db.City;
import edu.just.dusin.coolweather2.db.County;
import edu.just.dusin.coolweather2.db.Province;
        ...
        if(!TextUtils.isEmpty(response)){
            try{
                ...
                for(int i=0;i<allCountis.length();i++){
                    JSONObject countObject = allCountis.getJSONObject(i);
